...
let templateFn;
let ExplorerController = ExplorerController_1 = class ExplorerController {
    ...
    getOpenApiSpecUrl(restConfig) {
        var _a, _b;
        if (this.useSelfHostedSpec) {
            return './' + ExplorerController_1.OPENAPI_RELATIVE_URL;
        }
...
exports.ExplorerController = ExplorerController = ExplorerController_1 = tslib_1.__decorate([
